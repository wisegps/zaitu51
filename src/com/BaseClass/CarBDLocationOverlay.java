...
public class CarBDLocationOverlay extends ItemizedOverlay<OverlayItem> {
	...
	Boolean isSearch;
	Boolean IsSatellite;
	AVTBDActivity mAvtActivity;
	int mSize;

	public CarBDLocationOverlay(Drawable defaultMarker) {
		super(boundCenter(defaultMarker));
	}
	public CarBDLocationOverlay(Drawable Marker, Context context,String car_id, GeoPoint getPoint,boolean ISSEARCH,boolean IsSatellite,AVTBDActivity AVT,int size) {
		super(Marker);
		this.marker = Marker;
